  ...
  <div class="container">
    <div class="row justify-content-center">
      <div>
        ...
        <form action="<?php echo e(URL::to('prodins')); ?>" class="billing-form" method = 'post'>
          <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\watermelon.com\resources\views/productinsert.blade.php ENDPATH**/ ?>