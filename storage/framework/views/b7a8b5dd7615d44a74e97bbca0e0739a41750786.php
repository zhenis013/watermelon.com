      ...
      <div class="col-lg-12 d-block">
        <div class="row d-flex">
          <div class="col-md pr-4 d-flex topper align-items-center">
            ...
            <ul>
                <span><a class="text" href="<?php echo e(route('login')); ?>"><?php echo e(__('Login')); ?></a></span>
              </ul>
                <?php if(Route::has('register')): ?>
                  <ul>    <span>   <a class="text" href="<?php echo e(route('register')); ?>"><?php echo e(__('Register')); ?></a></span></ul>
                <?php endif; ?>
            <?php else: ?>
            <ul>
    ...
    <div class="collapse navbar-collapse" id="ftco-nav">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item cta cta-colored">
          <a href="cart">
            <span class="glyphicon glyphicon-shopping-cart"></span>[ <?php echo e(Session::has('cart') ? Session::get('cart')->totalqty : '0'); ?> ]
          </a>
        </li>
...
<?php /**PATH C:\xampp\htdocs\watermelon.com\resources\views/layouts/header.blade.php ENDPATH**/ ?>